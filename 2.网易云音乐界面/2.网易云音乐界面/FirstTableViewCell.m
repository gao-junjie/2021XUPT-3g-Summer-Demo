...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if ([self.reuseIdentifier isEqualToString:@"first"]) {
        ...
        _firstButton = [UIButton buttonWithType:UIButtonTypeSystem];        _firstButton.backgroundColor = [UIColor clearColor];
        ...
        _secondButton = [UIButton buttonWithType:UIButtonTypeSystem];        _secondButton.backgroundColor = [UIColor clearColor];
