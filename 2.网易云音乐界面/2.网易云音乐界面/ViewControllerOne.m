...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"icon29.png"] style:UIBarButtonItemStylePlain target:self action:nil];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        btnMain.frame = CGRectMake(5, 15, 80, 80);
        btnMain.backgroundColor = [UIColor clearColor];
        UIImage* imageMain = [UIImage imageNamed:@"icon27.png"];
    ...
    if (indexPath.section == 3) {
        if (indexPath.row == 0) {
            ...
            [cell addSubview:firstScrollView];
